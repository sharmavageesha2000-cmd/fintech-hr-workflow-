...
console.log('[Assessment Engine Builder] Compiling enterprise question bank (35 MCQs x 8 roles = 280 Total)...');
...
const BUSINESS_ANALYST_QUESTIONS = [
  {
    id: 601,
...
const bank = {
  ...
  "Full Stack AI Engineer": FULLSTACK_AI_QUESTIONS,
  "AI/ML Engineer": AIML_QUESTIONS,
  "Data Analyst": DATA_ANALYST_QUESTIONS,
  "Business Analyst": BUSINESS_ANALYST_QUESTIONS,
  "UI/UX Designer": UIUX_QUESTIONS,
  "Business Development Executive": BDE_QUESTIONS
};

// Verify all roles have 35 questions
...
console.log(`[Assessment Engine Builder] Successfully compiled assessment_questions.js! Total bytes: ${Buffer.byteLength(fileContent)}`);
